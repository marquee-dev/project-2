...
import BikeImage from "../assets/svartpilen.png"; // Path to the bike image
...
const Svartpilen = () => {
  ...
  const handleClick = () => {
    navigate('/models/svartpilen/booking')
  }
  useEffect(() => {
      ...
      <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", marginTop: '64px', mb: 10 }}>
        ...
        <Box ref={textRef} sx={{ width: { xs: "50%", md: "30%" }, padding: 2 }}>
          ...
          <Typography variant="body1" sx={{ marginY: 2 }}>
            The Husqvarna Svartpilen 401 is a nimble and stylish motorcycle that combines modern design with powerful performance. 
